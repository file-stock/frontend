...
const ImageCard: FC<ImageCardProps> = ({
  ...
  return (
    <div className={`relative ${cid? "w-[390px] group h-[460px]" : "w-[460px] group h-[460px]"}  transform transition-transform hover:scale-110 hover:border hover:border-border rounded-lg`}>
